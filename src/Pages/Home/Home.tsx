...
const Home: React.FC = () => {
  ...
  const tabs = [{ label: "Rent" }, { label: "Buy" }, { label: "Sell" }];
  ...
  return (
    <>
        ...
        <div className="max-w-screen-2xl grid max-md:flex max-md:flex-col grid-cols-3 gap-16 max-md:grid-cols-1 items-center justify-between mx-auto p-4 h-full">
          <div className="relative">
            ...
            <div className="absolute p-8 top-0 left-0 text-start">
              ...
              <button className="bg-secondary py-3 px-4 rounded-lg text-white">
                Browse Properties
              </button>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-b relative from-[#FFFFFF] to-[#F0EFFB] flex items-center justify-center p-24 max-md:p-4">
        <div className="max-w-screen-2xl grid grid-cols-2 gap-16 max-md:gap-8 max-md:grid-cols-1 items-center justify-between mx-auto p-4 w-full h-full">
            ...
            <div className="flex max-md:flex-col gap-5 items-center justify-between">
              <div className="flex items-center justify-start gap-3 p-2 rounded-lg bg-[#F0EFFB] border-2 border-[#E0DEF7] max-md:w-full">
                {tabs.map((tab, index) => (
                  <div
                    key={index}
                    className={`cursor-pointer px-4 py-2 w-16 max-md:w-full rounded-lg text-center ${
                      activeTab === index
                        ? "bg-white border border-[#E0DEF7]"
                        : ""
                    }`}
              ...
              <div className="relative min-w-80 max-md:w-full">
                ...
                <input
                  type="search"
                  placeholder="Search..."
                  className="placeholder:text-black/50 ps-12 w-full bg-[#F7F7FD] border-2 border-[#E0DEF7] p-3 rounded-lg"
                />
              </div>
            </div>
          </div>
          <div className="col-span-2">
            ...
            <div className="mt-10">
              <button className="bg-secondary text-white rounded-md py-3 px-5 hover:scale-95">
      ...
      <div className="bg-secondary">
        <div className="flex items-center justify-center p-24 max-md:p-4">
          <div className="col-span-2 flex items-center max-md:flex-col gap-10 w-full p-4">
            <h1 className="text-6xl max-md:text-2xl text-start max-md:text-center text-white font-bold">
              We make it easy for <span className="text-primary">tenants</span>{" "}
              and <span className="text-primary">landlords.</span>
            </h1>
            <p className="text-start max-md:text-center text-white">
        ...
        <div className="p-24 max-md:p-4">
          <div dir="ltr" className="swiper mySwiper">
            <div className="swiper-wrapper">
              <div className="swiper-slide w-full text-white text-2xl">
      ...
      <div className="bg-gradient-to-l relative from-[#F7F7FD]/50 via-[#F7F7FD] to-[#F7F7FD]/50">
        <div className="max-w-2xl mx-auto p-24 pb-12 max-md:p-4 w-full h-full flex flex-col gap-6">
          ...
          <div className="relative">
            <button
              className="bg-primary text-white absolute rounded-lg py-4 px-8 top-0 right-0 m-1"
              type="submit"
            >
              Submit
            </button>
